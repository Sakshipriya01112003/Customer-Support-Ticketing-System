...
const TicketForm = ({ onSubmit }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      const ticket = { ...values, id: uuidv4(), createdAt: new Date().toLocaleString() };
    ...
    <div>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 p-6">
        <div className="container mx-auto rounded-2xl bg-white shadow-xl p-8 w-full max-w-lg border border-gray-200">
          <h2 className="text-4xl font-bold mb-6 text-center text-gray-800">🎫 Create Ticket</h2>
          <form onSubmit={formik.handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              onClick={handleClick}
              className="w-full bg-blue-600 text-white font-semibold px-6 py-3 rounded-lg shadow-md hover:bg-blue-700 hover:shadow-lg transition transform hover:-translate-y-0.5"
            >
              Create Ticket
            </button>
          </form>
